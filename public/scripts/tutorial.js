var CommentBox = React.createClass({
  ...
  //CommentFormコンポーネントに、onCommentSubmitというpropsでメソッドを渡してる
  render: function(){
    return(
      <div className='commentBox'>
        <h1>Comments</h1>
        <CommentList data={ this.state.data } />
        <CommentForm onCommentSubmit={ this.handelCommentSubmit } />
      </div>
    );
  }
});
...
var CommentForm = React.createClass({
  ...
  handleSubmit: function(e){
    ...
    //CommentBoxで定義されたメソッドを使って、フォームから取得したデータをサーバーに投げてる
